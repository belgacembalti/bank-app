...
export function Sidebar({ activeSection, onSectionChange, userRole, onLogout }: SidebarProps) {
  const userMenuItems = [
    ...
    <aside className="w-64 bg-white dark:bg-navy-800 border-r border-gray-200 dark:border-navy-700 h-full overflow-y-auto">
      <div className="p-4">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-navy-700">
          <button
            onClick={onLogout}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-danger-600 hover:bg-danger-50 dark:hover:bg-danger-900/20 transition-colors"
          >
